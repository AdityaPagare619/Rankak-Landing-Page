    ...
    <main className="relative w-full max-w-7xl mx-auto px-6 py-12 lg:py-20 flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
      ...
      <div className="w-full lg:w-1/2 z-10 flex flex-col gap-10">
        ...
        <div className="space-y-8 motion-fade-up motion-fade-up-delay-2">
          <h1 className="font-display font-extrabold text-6xl lg:text-[5.5rem] leading-[1.05] text-text-main-light dark:text-white tracking-tight">
            You know your <span className="text-primary relative inline-block hover:scale-105 transition-transform duration-300 ease-brand-curve">
              timeline.
              <svg className="absolute w-full h-4 -bottom-2 left-0 text-accent" preserveAspectRatio="none" viewBox="0 0 100 15">
                <path d="M0 5 Q 25 12 50 5 T 100 5" fill="none" stroke="currentColor" strokeLinecap="round" strokeWidth="8"></path>
              </svg>
            </span> <br />
            We adapt to it.
          </h1>
          <p className="text-xl lg:text-2xl text-text-muted-light dark:text-text-muted-dark font-medium leading-relaxed max-w-lg">
        ...
        <div className="flex flex-col sm:flex-row gap-5 items-start pt-6 motion-scale-pop motion-delay-cards">
          <button className="w-full sm:w-auto bg-primary text-white font-display font-bold text-lg py-4 px-10 rounded-full shadow-[0_6px_0_0_#3730a3] hover:bg-indigo-600 hover:shadow-[0_4px_0_0_#3730a3] hover:translate-y-[2px] active:translate-y-[6px] active:shadow-none transition-all duration-300 ease-brand-curve flex items-center justify-center gap-3 group">
            Start Practicing
            <span className="material-symbols-outlined transition-transform duration-300 group-hover:translate-x-1">arrow_forward</span>
          </button>
          <button className="w-full sm:w-auto bg-transparent border-2 border-gray-200 dark:border-gray-600 text-text-muted-light dark:text-text-muted-dark font-display font-bold text-lg py-4 px-10 rounded-full hover:bg-gray-50 dark:hover:bg-gray-800 hover:border-primary/30 hover:text-primary transition-all duration-300 ease-brand-smooth flex items-center justify-center gap-2 group">
        ...
        <div className="flex items-center gap-6 pt-4 text-sm font-bold text-text-muted-light dark:text-text-muted-dark motion-fade-up motion-fade-up-delay-3">
          <div className="flex -space-x-3">
            <img alt="User" className="w-12 h-12 rounded-full border-4 border-background-light dark:border-background-dark transition-transform hover:scale-110 duration-200" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDnuqYPrqJs2-H3rBz5bW6cFEq4MqS3t88fdzf94YtYeXfsb8Ar0gMw7kGp--VjRZ92Z8Bi0eYsXrzBBfUidynCKFGtvxxg2XjqDlToR8M4C-ZCPal9j1xnnfUsTtgcalEpaOi4vEBn_DP-1hAGm_Zw1l3tOiJ4YEGvThhX7hUP4R0wd0kdpm9HbishNWTBzo9pjBqvZkDLJxmIuWtb3rB-W9Er1mS7xzxMIxIvVtodY_WyJPIYNUXtzZeliWRVYL-7KK27uHY9dEQ" />
            <img alt="User" className="w-12 h-12 rounded-full border-4 border-background-light dark:border-background-dark transition-transform hover:scale-110 duration-200 delay-75" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAzjdB7XyH1bpQiEtENWH8gz9bWxP5ZkRt_9SdgZhmgwA1O7sUPt85lSsWBkof0NtBULiFkXHBlux4DoeODMknPt8EfOgkQBQXIxmiYQtaCEvLwby3QAjmTwgDtc6tPBUg1oxaKGF3Q0QunKSM0JSSNDFlStfwzVhLUO7SuRuWbM74pfmmzUcLt5B9E-hlDEo3b3gRzUJsVCK5Qu1hScz2O-emetRs2FwlYeaPZCeuHh4B7iaufHb74NmdxLiMrOO9b98F3Y4IXnfw" />
            <img alt="User" className="w-12 h-12 rounded-full border-4 border-background-light dark:border-background-dark transition-transform hover:scale-110 duration-200 delay-150" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDDpRowcAY6Frc4NbK9ekVBKA8Uk3a92067tfe4JRMVDT4zw-jBxCCJfEV5oN58HQDKH_LwEfzPe5E88L3wi68g-Meh71Hyq5dgfqsQeGvgFhVViBlo3y9CAdzV5ngGgCyj7qT4n_Red0mtCktYKI9H0C-mEOw8vXMG9-rutK0FuUZMTP5iao0t19JEPyLjmG-TkzjWyXHX3yPij8v_M2Y8LEhLN0LEMe8bUjihKjFbqnMh0_mUaivTaTKEY_Lgbhw0YY-YvszpLoo" />
            <div className="w-12 h-12 rounded-full border-4 border-background-light dark:border-background-dark bg-accent flex items-center justify-center text-xs text-black font-bold transition-transform hover:scale-110 duration-200 delay-200">
              +2k
            </div>
          </div>
      ...
      <div className="w-full lg:w-1/2 relative min-h-[600px] flex items-center justify-center perspective-1000 motion-fade-up motion-fade-up-delay-2">
        ...
        <div className="relative z-20 w-[24rem] h-[24rem] flex items-center justify-center animate-float">
          ...
          <div className="absolute -left-16 top-24 bg-white dark:bg-gray-800 p-5 rounded-3xl shadow-xl border border-gray-100 dark:border-gray-600 flex items-center gap-4 animate-card-left w-auto min-w-[180px] z-20 hover:scale-105 transition-transform duration-300 ease-brand-curve cursor-default">
            ...
            <div>
              <div className="text-[11px] text-text-muted-light dark:text-text-muted-dark font-bold uppercase tracking-wider mb-0.5">Time Left</div>
              <div className="text-xl font-display font-extrabold text-text-main-light dark:text-text-main-dark leading-none">145 Days</div>
            </div>
          </div>
          <div className="absolute -right-16 bottom-24 bg-white dark:bg-gray-800 p-5 rounded-3xl shadow-xl border border-gray-100 dark:border-gray-600 flex flex-col items-center gap-3 animate-card-right w-56 z-20 hover:scale-105 transition-transform duration-300 ease-brand-curve cursor-default">
            <div className="w-full flex justify-between items-center mb-1">
              <span className="text-[11px] text-text-muted-light dark:text-text-muted-dark font-bold uppercase tracking-wider">Your Path</span>
            ...
            <div className="w-full h-2 bg-gray-100 dark:bg-gray-700 rounded-full overflow-hidden relative">
              <div className="absolute top-0 left-0 h-full bg-gradient-to-r from-primary to-secondary w-2/3 rounded-full animate-pulse"></div>
              <div className="absolute top-1/2 left-2/3 -translate-y-1/2 -translate-x-1/2 w-4 h-4 bg-white border-[3px] border-primary rounded-full z-10 shadow-sm"></div>
            </div>
            <div className="flex justify-between w-full mt-2 items-center">
              <span className="text-xs font-bold text-primary bg-indigo-50 px-3 py-1 rounded-lg">Optics</span>
              <span className="text-[11px] font-bold text-text-muted-light flex items-center">Next <span className="material-symbols-outlined text-xs ml-0.5">arrow_forward</span></span>
            </div>
          </div>
          <div className="absolute -top-12 right-0 bg-accent text-amber-900 px-5 py-2 rounded-full shadow-lg border-2 border-white/30 animate-float-delayed font-bold text-sm flex items-center gap-1.5 z-30 transform rotate-6 hover:rotate-3 transition-transform duration-300">
